...
import { obtenerNombreConfiguracion, obtenerreportesesiones } from '../logica/Reportes';
...
const ImprimirReporteSesiones = () => {
  ...
  useEffect(() => {
    ...
    const fetchDatos = async () => {
      try {
        const resultado = await obtenerreportesesiones(sede, semestre, escuela, curricula, curso, seccion, token);
  ...
  const columnasEncabezado = [
    [
      { titulo: 'SEMANA', rowSpan: 2 },
      { titulo: 'CONTENIDO', rowSpan: 2 },
      { titulo: 'FECHA', rowSpan: 2 },
      { titulo: 'CONCLUIDO', rowSpan: 2 },
    ],
        ...
        <div className="row mt-3">
          <div className="col-12">
            {loading ? (
              ...
              <div className="tabla-acta-sesiones">
                <TablaCursoSub
                  datos={datos}
...
export default ImprimirReporteSesiones;