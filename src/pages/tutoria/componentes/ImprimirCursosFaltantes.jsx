...
import { obtenerCursosFaltantes } from "../logica/DatosTutoria";
...
const ImprimirCursosFaltantes = () => {
  ...
  let alumno = "", sede = "", escuela = "", curricula = "", semestre = "";

  try {
    if (codigoParam) {
      const d1 = atob(codigoParam);
      const d2 = atob(d1);
      [alumno, sede, escuela, curricula, semestre] = d2.split("|");
    }
  } catch (e) {}
  ...
  const cargar = async () => {
    const resp = await obtenerCursosFaltantes(
      alumno,
      sede,
      escuela,
      curricula,
  ...
  if (loading) return <TablaSkeleton filas={10} />;
      ...
      <div className="container mt-4 ficha-container">
        ...
        <div className="d-flex justify-content-between align-items-center mb-3">
          ...
          <div className="text-center">
            ...
            <h6><strong>CURSOS FALTANTES</strong></h6>
        ...
        {/* TABLA */}
        <table className="table table-bordered text-center tabla-cursos mt-3">
        ...
        {/* TOTALES — estilo alineado como en PHP */}
...
export default ImprimirCursosFaltantes;
